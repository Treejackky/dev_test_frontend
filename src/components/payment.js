...
import Debit_Card from "../debit_card.png";
import Net_bank from "../net_banking.png";
import PhonePay from "../phone_pay.png";
                  ...
                  <div className="flex">
                    <div className="p-6 w-1/2">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul class="space-y-4">
                          <li onClick={(_)=>{handlefinal()}} class="flex justify-between hover:text-blue-600 items-center px-4 py-2 border hover:border-blue-600 rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                            <div>
                            <img
                              src={Debit_Card}
                              alt="Debit Card Icon"
                          ...
                          <li onClick={(_)=>{handlefinal()}} class="flex justify-between hover:text-blue-600 hover:border-blue-600 items-center px-4 py-2 border rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                            <div>
                            <img
                              src={UPI}
                              alt="UPI Icon"
                    ...
                    <div>
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto mt-">
                  ...
                  <div className="">
                    ...
                    <div>
                      <div class="p-6 rounded-lg max-w-md mx-auto mt-3">
                        <div class="space-y-2 bg-white p-6 rounded-lg shadow-md max-w-md mx-auto mt-3">
                          <div className="flex justify-between space-x-24">
                            <p class="text-gray-500 text-sm">
                              {data && data.room_num} room x{" "}
                              {data && data.room_num - 1} night
